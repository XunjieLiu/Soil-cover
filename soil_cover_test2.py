...
def Train():
    dataset_folder = '/mnt/xunjie_3090/soil_cover_datasets/soil_cover_0322/soil_cover_0322'
...
def Predict():
    ...
    test_folder = '/mnt/xunjie_3090/soil_cover_datasets/soil_cover_0322/test/'
    validate_folder = '/mnt/xunjie_3090/soil_cover_test_results/0322/'
    ...
    cfg.MODEL.WEIGHTS = os.path.join('/mnt/xunjie_3090/soil_cover_models/3090/output_0322/', "model_final.pth")
    ...
    for name in image_names:
        ...
        print("Output size: ", result_image.shape)
